"""
Django settings for ITAuditHelper project.
...
SECRET_KEY = 'django-insecure-b077fec^)&30dan@z8fl&%5=+k-nl@h9ab&e&0r1$e9pocwrrl'
...
ROOT_URLCONF = 'ITAuditHelper.urls'
...
WSGI_APPLICATION = 'ITAuditHelper.wsgi.application'
